...
#The goal is this:
#I write a few definitions and premises, and then the LogicTree automatically generates the arguments that follow from the definitions and premises, and then it prints it out.
